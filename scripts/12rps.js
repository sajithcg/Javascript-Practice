...
function showConfirmation() {
    ...
    <button class="js-resetYes reset-confirm-button">
    Yes</button>
    <button class="js-resetNo reset-confirm-button">
    No</button>
    `;

    document.querySelector('.js-resetYes')
        .addEventListener('click', () => {
            resetButton();
            hideReset();
    });
    
    document.querySelector('.js-resetNo')
        .addEventListener('click', () => {
            hideReset();
    });
}
